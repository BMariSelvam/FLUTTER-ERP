...
class _CustomerScreenState extends State<CustomerScreen> {
  ...
  void initState() {
    ...
    Invoice? customerCodePassing = Get.arguments as Invoice?;
    controller.getAllCurrency();
    controller.dateController.text = controller.selectedDate.toString();
    controller.deliveryDateController.text =
        controller.delSelectedDate.toString();
    ...
    if (customerCodePassing != null) {
      ...
      customerCodePassing.invoiceDetail?.first.productName;
    }
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CustomerController>(builder: (logic) {
                            ...
                            onTap: () async {
                              showDatePicker(
                                ...
                                setState(() {
                                  ...
                                  controller.dateController.text =
                                  '${controller.selectedDate.day}-${controller
                                      .selectedDate.month}-${controller
                                      .selectedDate.year}';
                                  // '${_selectedDate.year}-${_selectedDate.month}-${_selectedDate.day}';
                                  controller.date =
                                  '${controller.selectedDate.year}-${controller
                                      .selectedDate.month}-${controller
                                      .selectedDate.day}';
                                });
                              });
                        ...
                        suffixIcon: GestureDetector(
                            onTap: () async {
                              showDatePicker(
                                  ...
                                  .then((value) {
                                setState(() {
                                  controller.delSelectedDate = value!;
                                  controller.deliveryDateController.text =
                                  '${controller.delSelectedDate
                                      .day}-${controller.delSelectedDate
                                      .month}-${controller.delSelectedDate
                                      .year}';
                                  // '${_selectedDate.year}-${_selectedDate.month}-${_selectedDate.day}';
                                  controller.delDate =
                                  '${controller.delSelectedDate
                                      .year}-${controller.delSelectedDate
                                      .month}-${controller.delSelectedDate
                                      .day}';
                                });
                              });
