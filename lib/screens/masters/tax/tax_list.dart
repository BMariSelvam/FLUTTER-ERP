...
class _TaxListState extends State<TaxList> {
  late TaxListController listController;

  @override
  void initState() {
    super.initState();
    listController = Get.put(TaxListController());
    listController.taxListGet();
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<TaxListController>(builder: (logic) {
            ...
            Padding(
              ...
              child: Row(
                  ...
                  children: [
                    ...
                    // ),
                    GestureDetector(
                      onTap: () => Get.toNamed(AppRoutes.addTax),
                      child: Container(
  ...
  ListView list() {
    return ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: listController.getTaxList.value?.length,
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: CustomGradient(
                              child: Text(
                                listController
                                        .getTaxList.value?[index].taxName ??
                                    '',
                                style: TextStyle(
                                    fontSize: 14,
                                    fontFamily: MyFont.myFont2,
                ...
                Container(
                  ...
                  child: Table(
                    ...
                    children: [
                      ...
                      TableRow(children: [
                        Text(
                          listController.getTaxList.value?[index].taxCode
                                  .toString() ??
                              "",
                          style: TextStyle(
                              fontSize: 14,
                        ...
                        Text(
                          listController.getTaxList.value?[index].taxPercentage
                                  .toString() ??
                              '',
                          style: TextStyle(
                              fontSize: 14,
                        ...
                        Text(
                          listController.getTaxList.value?[index].taxType
                                  .toString() ??
                              '',
                          style: TextStyle(
                              fontSize: 14,
