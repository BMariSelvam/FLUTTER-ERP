...
class AddSubCategoryController extends GetxController with StateMixin {
  RxBool isLoading = false.obs;
  String? messages;
  final addSubCategoryKey = GlobalKey<FormState>();
  late CreateSubCategoryModel createSubCategoryModel;
  bool selected = true;
