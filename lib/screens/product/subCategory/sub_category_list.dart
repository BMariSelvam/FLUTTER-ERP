...
import 'package:erp/screens/product/subCategory/sub_category_list_controller.dart';
...
class _SubCategoryListState extends State<SubCategoryList> {
  late SubCategoryListController listController;

  @override
  void initState() {
    super.initState();
    listController = Get.put(SubCategoryListController());
    listController.subCategoryListGet();
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<SubCategoryListController>(builder: (logic) {
            ...
            Padding(
              ...
              child: Row(
                  ...
                  children: [
                    ...
                    // ),
                    GestureDetector(
                      onTap: () => Get.toNamed(AppRoutes.addSubCategory),
                      child: Container(
  ...
  ListView list() {
    return ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: listController.getSubCategoryList.value?.length,
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomGradient(
                              child: Text(
                                listController.getSubCategoryList.value?[index]
                                        .name ??
                                    '',
                                style: TextStyle(
                                    fontSize: 14,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              listController
                                      .getSubCategoryList.value?[index].code ??
                                  '',
                              style: TextStyle(
                                  fontSize: 14,
                                  fontFamily: MyFont.myFont2,
