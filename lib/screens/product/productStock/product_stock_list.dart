...
class _ProductStockListState extends State<ProductStockList> {
          ...
          Padding(
            ...
            child: Row(
                ...
                children: [
                  ...
                  // ),
                  GestureDetector(
                    onTap: () => Get.toNamed(AppRoutes.addProductStock),
                    child: Container(
  ...
  Container select(String name) {
    return Container(
      margin: const EdgeInsets.only(top: 5, bottom: 5, left: 0, right: 15),
      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 4),
      decoration: BoxDecoration(
        color: hexStringToColor('E0DEFB'),
        borderRadius: BorderRadius.circular(5),
      ),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
