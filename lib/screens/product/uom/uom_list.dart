...
import 'package:erp/screens/product/uom/uom_list_controller.dart';
...
class _UomListState extends State<UomList> {
  late UomListController listController;

  @override
  void initState() {
    super.initState();
    listController = Get.put(UomListController());
    listController.uomListGet();
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<UomListController>(builder: (logic) {
            ...
            Padding(
              ...
              child: Row(
                  ...
                  children: [
                    ...
                    // ),
                    GestureDetector(
                      onTap: () => Get.toNamed(AppRoutes.addUom),
                      child: Container(
  ...
  ListView list() {
    return ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: listController.getUomList.value?.length,
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: CustomGradient(
                              child: Text(
                                listController.getUomList.value?[index].name ??
                                    '',
                                style: TextStyle(
                                    fontSize: 14,
                                    fontFamily: MyFont.myFont2,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              listController.getUomList.value?[index].code ??
                                  '',
                              style: TextStyle(
                                  fontSize: 14,
                                  fontFamily: MyFont.myFont2,
