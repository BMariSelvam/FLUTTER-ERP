import 'package:erp/screens/product/product/product_list_controller.dart';
...
class _ProductListState extends State<ProductList> {
  late ProductListController listController;

  @override
  void initState() {
    super.initState();
    listController = Get.put(ProductListController());
    listController.productListGet();
  }
  ...
  ListView list() {
    return ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: listController.getProductList.value?.length,
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: CustomGradient(
                              child: Text(
                                listController
                                        .getProductList.value?[index].name ??
                                    '',
                                style: TextStyle(
                                    fontSize: 14,
                                    fontFamily: MyFont.myFont2,
                ...
                Container(
                  ...
                  child: Table(
                    ...
                    children: [
                      ...
                      TableRow(children: [
                        Text(
                          listController.getProductList.value?[index].code ??
                              '',
                          style: TextStyle(
                              fontSize: 14,
                              fontFamily: MyFont.myFont2,
                        ...
                        Text(
                          listController
                                  .getProductList.value?[index].categoryName ??
                              '',
                          style: TextStyle(
                              fontSize: 14,
                              fontFamily: MyFont.myFont2,
