...
class AddBrandController extends GetxController with StateMixin {
  ...
  String? messages;
  final addBrandKey = GlobalKey<FormState>();
  late CreateBrandModel createBrandModel;
  bool selected = true;

  TextEditingController brandCodeController = TextEditingController();
  ...
  onSaved() async {
    ...
    NetworkManager.post(
            URl: HttpUrl.postBrand, params: createBrandModel.toJson())
        .then((apiResponse) {
