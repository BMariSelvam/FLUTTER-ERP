...
class GoodsReceiveList extends StatefulWidget {
  const GoodsReceiveList({Key? key}) : super(key: key);

  @override
  State<GoodsReceiveList> createState() => _GoodsReceiveListState();
}

class _GoodsReceiveListState extends State<GoodsReceiveList> {
  @override
          ...
          Padding(
            ...
            child: Row(
                ...
                children: [
                  ...
                  // ),
                  GestureDetector(
                    onTap: () => Get.toNamed(AppRoutes.addGoodsReceive),
                    child: Container(
