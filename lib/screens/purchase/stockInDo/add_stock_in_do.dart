...
class AddStockInDo extends StatefulWidget {
  const AddStockInDo({Key? key}) : super(key: key);

  @override
  State<AddStockInDo> createState() => _AddStockInDoState();
}

class _AddStockInDoState extends State<AddStockInDo> {
  bool selected = false;
          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                ...
                //     name: 'Stock In Do Saved Successfully..!',
                //     filename: AppRoutes.goodsReceiveList)),
                onPressed: () {},
                child: Ink(
                  decoration: BoxDecoration(
