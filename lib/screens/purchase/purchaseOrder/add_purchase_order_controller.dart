...
import 'package:erp/Model/RequestModel/CreatePurchaseOrderModel.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart';

class AddPurchaseOrderController extends GetxController with StateMixin {
  RxBool isLoading = false.obs;
  final addPurchaseOrderKey = GlobalKey<FormState>();
  String? messages;
  bool selected = true;
  late CreatePurchaseOrderModel createPurchaseOrderModel;
  ...
  onSaved() async {
    ...
    NetworkManager.post(
            ...
            params: createPurchaseOrderModel.toJson())
        .then((apiResponse) {
