...
import 'package:erp/screens/purchase/purchaseOrder/add_purchase_order_controller.dart';
...
class AddPurchaseOrder extends StatefulWidget {
  const AddPurchaseOrder({Key? key}) : super(key: key);
...
class _AddPurchaseOrderState extends State<AddPurchaseOrder> {
  ...
  late AddPurchaseOrderController addPurchaseOrderController;

  @override
  void initState() {
    super.initState();
    addPurchaseOrderController = Get.put(AddPurchaseOrderController());
  }

  @override
  Widget build(BuildContext context) {
    return Form(
      key: addPurchaseOrderController.addPurchaseOrderKey,
      child: Scaffold(
          appBar: AppBar(
            toolbarHeight: 80,
            ...
            child: Column(
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      FlutterSwitch(
                          ...
                          value: addPurchaseOrderController.selected,
                          onToggle: (val) {
                            setState(() {
                              addPurchaseOrderController.selected = val;
                            });
                          })
                    ],
                  ),
                ...
                ElevatedButton(
                  ...
                  //     name: 'Purchase Order Saved Successfully..!',
                  //     filename: AppRoutes.stockInDoList)),
                  onPressed: () {},
                  child: Ink(
                    decoration: BoxDecoration(
                        gradient: const LinearGradient(
