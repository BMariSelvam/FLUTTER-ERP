...
import 'package:erp/screens/sales/salesReturn/sales_return_list_controller.dart';
...
class _SalesReturnListState extends State<SalesReturnList> {
  ...
  void initState() {
    ...
    controller.salesReturnListGet();
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<SalesReturnListController>(builder: (logic) {
            ...
            Padding(
              ...
              child: Row(
                  ...
                  children: [
                    ...
                    // ),
                    GestureDetector(
                      onTap: () => Get.toNamed(AppRoutes.addSalesReturn),
                      child: Container(
  ...
  ListView list() {
    return ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: controller.getSalesReturn.value?.length,
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: CustomGradient(
                              child: Text(
                                controller.getSalesReturn.value![index]
                                        .customerName ??
                                    '',
                                style: TextStyle(
                                    fontSize: 14,
                ...
                Container(
                  ...
                  child: Table(
                    ...
                    children: [
                      ...
                      TableRow(children: [
                        Text(
                          controller.getSalesReturn.value![index].tranNo ?? '',
                          style: TextStyle(
                              fontSize: 14,
                              fontFamily: MyFont.myFont2,
                              fontWeight: FontWeight.bold,
                        ...
                        Text(
                          formatDate(controller
                                  .getSalesReturn.value![index].tranDate ??
                              ''),
                          style: TextStyle(
                              fontSize: 14,
                              fontFamily: MyFont.myFont2,
                        ...
                        Text(
                          '\$${controller.getSalesReturn.value![index].total ?? ''}',
                          style: TextStyle(
                              fontSize: 14,
                              fontFamily: MyFont.myFont2,
                              fontWeight: FontWeight.bold,
