...
class AddDeliveryOrder extends StatefulWidget {
  const AddDeliveryOrder({Key? key}) : super(key: key);

  @override
  State<AddDeliveryOrder> createState() => _AddDeliveryOrderState();
}

class _AddDeliveryOrderState extends State<AddDeliveryOrder> {
  bool selected = false;
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () => Get.to(SuccessfullyMsgScreen(
                    name: 'Delivery Order Saved Successfully..! ',
                    filename:
                        Get.offNamed(AppRoutes.salesInvoicesTabBarScreen))),
                child: Ink(
                  decoration: BoxDecoration(
                      gradient: const LinearGradient(
                          colors: [
