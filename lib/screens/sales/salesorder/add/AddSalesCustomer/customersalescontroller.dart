...
class CustomerSalesController extends GetxController with StateMixin {
  ...
  // Rx<List<GetAllCurrencyModel>?> cucc = (null as List<GetAllCurrencyModel>?).obs;
    ...
    await NetworkManager.get(
      ...
      if (apiResponse.apiResponseModel != null &&
        ...
        if (apiResponse.apiResponseModel!.data != null) {
          ...
          // currencyController.text = getByCodeCurrency.value?.first.name ?? "";
          // currency = getByCodeCurrency.value?.first.name ?? "";
          ...
          outstandingController.text =
              (getCustomerByCodeList.value?.first.outstandingAmount ?? 0.00)
                  .toString();
          delDate = orderDate.toString();
          delDate = deliveryDate.toString();
