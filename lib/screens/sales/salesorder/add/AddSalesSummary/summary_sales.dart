...
class _SummarySalesState extends State<SummarySales> {
  ...
  void initState() {
    ...
    if (customerController.customerAddressLine1Controller.text.isEmpty &&
      ...
      address =
          '${customerController.customerAddressLine1Controller.text}, ${customerController.customerAddressLine2Controller.text}, ${customerController.customerAddressLine3Controller.text}, ${customerController.countryController.text}';
    }
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        ...
                        controller.createSalesOrder.authImgBase64String =
                            userSignature;
                        controller.createSalesOrder.signImgBase64String =
                            customerSignature;
                      });
                      print('userSignature');
                      print(sign1?.userSignatureExportedImage);
                      // print(controller.createSalesOrder.authImgBase64String);
                      print('userSignature');
                      print('customerSignature');
                      print(sign1?.customerSignatureExportedImage);
                      // print(controller.createSalesOrder.signImgBase64String);
                      print('customerSignature');
                    },
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () {
                                if (isAddProduct == true) {
                                  ...
                                  if (controller.productList != null) {
                                    if (controller.productList!.isEmpty) {
                                      ...
                                      controller.createSalesOrder = SalesOrder(
                                        ...
                                        signatureimage: controller
                                                .createSalesOrder
                                                .signImgBase64String ??
                                            '',
                                        cameraimage: controller.createSalesOrder
                                        ...
                                        fDiscountPerc: 0,
                                        currencyValue: 1,
                                        authorizedSignature: controller
                                                .createSalesOrder
                                                .authImgBase64String ??
                                            '',
                                        authorizedImage: "",
                                  ...
                                  FocusScope.of(context).unfocus();
                                  if (controller.productService.productListItems
                                      .isEmpty) {
                                    Get.snackbar(
                                      margin: const EdgeInsets.all(20),
                                      backgroundColor: MyColors.primaryCustom,
                                    ...
                                    controller.createSalesOrder = SalesOrder(
                                      ...
                                      locationCode: "$branchCode",
                                      taxCode: int.parse(
                                        customerController.getCustomerByCodeList
  ...
  void locationPermission() async {
    print("It's a location before");
    PermissionStatus locationStatus = await Permission.location.request();

    LocationPermission permission;
    permission = await Geolocator.requestPermission();
    print("It's a location after");
