...
class StockAdjustmentList extends StatefulWidget {
  const StockAdjustmentList({Key? key}) : super(key: key);

  @override
  State<StockAdjustmentList> createState() => _StockAdjustmentListState();
}
...
class _StockAdjustmentListState extends State<StockAdjustmentList> {
  @override
          ...
          Padding(
            ...
            child: Row(
                ...
                children: [
                  ...
                  // ),
                  GestureDetector(
                    onTap: () => Get.toNamed(AppRoutes.addStockAdjustment),
                    child: Container(
